---
title: 'Why should Social Return on Investment be avoided at all costs?'
date: 2016-01-01
...
Instead of embracing established impact and economic evaluation tools, some [NFPs](http://www.visionaustralia.org/about-us/who-we-are-and-what-we-do/governance/social-return-on-investment) have latched on to an increasingly popular concept known as social return on investment (SROI).
...
Calculating the cost benefit of social outcomes has until recently been a protracted and challenging task, since the [calculation of a CBA](http://www.archerfish.net/insights/how-can-cba-prioritise-social-policy-spending) entails monetising variables like the value of a life or the value of injuries suffered by a victim of crime. 

The emergence of [repositories of effect sizes](http://www.campbellcollaboration.org/) — that reliably and validly measure outcomes of a wide range of interventions — and the development of libraries of shadow prices means that techniques involving little more than wild guesses are redundant dead ends.
